...
+ 考点9	真理的绝对性和相对性及其辩证关系
  ...
  + 命题角度1：什么是真理的绝定性和相对性？  ——*选择题，70%*
    ...
    + 真理的决定性
      ...
      + 含义：
        ...
        2. 人类认识按其本性来说，能够正确认识无限发展着的物质世界，认识每前进异步，都是对无限发展着的物质世界的接近。
  ...
  + 命题角度2：真理的绝对性和相对性的关系是什么?  ——*选择题，80%*
    ...
    + 绝对真理和相对真理又是**辩证转化**的：  
      ...
      真理是有相对走向绝对的永无止尽的过程，任何真理的认识都是**由相对真理向绝对真理转化过程**中的一个环节。人们对客观世界的认识，就是由**相对真理到绝对真理不断发展和转化**的过程。
...
+ 考点11	检验真理的实践标准
  ...
  + 命题角度1：为什么实践是检验真理的唯一标准？  ——*选择题，40%*
    + 从真理的本性看，真理是人们对客观事物及其发展规律的正确反映，它的本质在于主观和客观相结合；
...
+ 考点12	实践标准的确定性和不确定性
  ...
  + 命题角度2：实践标准的不确定性是什么？  ——*选择题，20%*
    + 实践作为检验认识真理性的标准的不确定性即相对性，则是指实践对认识真理的检验的条件性，即任何实践都收到一定具体条件的制约，因而都具有一定的局限性，都是一 个不断运动发展的过程。

+ 考点13	价值评价

  + 命题角度1：价值即价值的特点是什么？  ——*选择题，50%*

    + 价值的**主体性**：主客体之间的价值关系不是一种自然的现成关系，而是主题在实践基础上确立的同客体之间的**一种创造性关系**。
  ...
  + 命题角度2：价值评价的特点是什么？  ——*选择题，60%*
    ...
    + 一般来说，**评价结果与评价主题有直接联系，是依主体的特点而转移的**；
